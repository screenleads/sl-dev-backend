...
public interface PromotionRedemptionRepository extends JpaRepository<PromotionRedemption, Long> {
    ...
    List<PromotionRedemption> findByPromotionAndCustomer(@Param("promotionId") Long promotionId,
    ...
    long countByDevice_IdAndCreatedAtAfter(@Param("deviceId") Long deviceId,
