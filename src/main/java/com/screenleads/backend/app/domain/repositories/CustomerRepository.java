...
public interface CustomerRepository extends JpaRepository<Customer, Long>, JpaSpecificationExecutor<Customer> {
    ...
    // Query method for finding all customers belonging to a company through PromotionRedemption
    @Query("SELECT DISTINCT c FROM Customer c JOIN c.redemptions pr WHERE pr.promotion.company.id = :companyId")
