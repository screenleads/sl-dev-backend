 ...
 * Provides cohort analysis, funnel metrics, attribution, and time-series
 * aggregations
 */
public interface AdvancedAnalyticsService {

    /**
     * Cohort Analysis: Group customers by acquisition date and track their behavior
     * over time
     * 
     ...
     * 
     * @param companyId   Company ID
     * @param metric      Metric to aggregate (impressions, conversions, revenue,
     *                    etc.)
     * @param startDate   Start date
     * @param endDate     End date
