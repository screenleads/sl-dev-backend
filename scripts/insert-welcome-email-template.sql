...
-- NOTAS:
-- ============================================================================
-- 1. Las empresas pueden personalizar esta plantilla desde el dashboard
...
-- 3. El sistema automáticamente buscará una plantilla llamada "WELCOME_EMAIL"
--    o que contenga "Bienvenida" o "Welcome" en su nombre
-- 4. Si no encuentra plantilla personalizada, usa una plantilla predeterminada
-- ============================================================================
